...
<h:body>
	<h:messages id="facesMessage" />
	<h:form prependId="false">
		<h:commandButton value="Who Am I ?" action="\#{loginController.renderLoggedIn}" id="whoAmI">
			<f:ajax render="signedAs" />
		</h:commandButton>
		<h:panelGroup id="signedAs">
